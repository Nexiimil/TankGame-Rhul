...
{
    [SerializeField] private int cannons = 1; //the initial number of cannons the player has
	...
	public int getCannons() {return this.cannons;} //fetches the number of cannons
	public void setCannons(int cannons) {this.cannons = cannons;} //sets the number of cannons
    ...
    void Recalculate() //recalculates the position of a number of cannons
    {
        ...
        float angleOffset = (360/getCannons()); //calculates the angle between each cannon
        ...
        for(int n=0; n<getCannons(); n++){ //repeat for n cannons
